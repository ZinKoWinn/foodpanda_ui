...
import 'package:foodpanda_ui/widgets/pickup-list.dart';
import 'package:foodpanda_ui/widgets/pickup-list-header.dart';

class PickUpPage extends StatelessWidget {
  final List<HeaderBox> boxItem = HeaderBox.getHeaderBoxList;
  final List<PickUp> items = PickUp.getPickUpItemList;
  @override
